...
1. **Create Failing Test Case**
   ...
   - Use the `kit:tdd` skill for writing proper failing tests
...
**Related skills:**
- **kit:tdd** - For creating failing test case (Phase 4, Step 1)
- **kit:verify** - Verify fix worked before claiming success
